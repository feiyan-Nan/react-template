...
import './index.less'
import { translateMarkdown } from '@/plugin/common'
...
class Edit extends Component {
  ...
  handleSubmit = () => {
    ...
    if (this.state.isEdit) {
      ArticleService.editArticle({ ...params, articleId: this.state.articleId }).then(res => {
        Modal.confirm({
          title: '文章修改成功！是否查看详情？',
      ...
      ArticleService.createArticle(params).then(res => {
        Modal.confirm({
          title: '文章创建成功！是否立即查看？',
